...
class PrintTextFont(
    ...
    constructor(typeface: Font, text: String, fontSize: FontSize = FontSize.NORMAL, align: Align = Align.LEFT, fontStyle: FontStyle = FontStyle.NORMAL) :
        this(typeface, text, fontSize.size, align, fontStyle)

    private fun styledFont(): Font {
        val base = typeface.deriveFont(fontSize.toFloat())
    ...
    fun copy(text: String, typeface: Font? = null, fontSize: Int? = null, align: Align? = null, fontStyle: FontStyle? = null): PrintTextFont {
        return PrintTextFont(typeface ?: this.typeface, text, fontSize ?: this.fontSize, align ?: this.align, fontStyle ?: this.fontStyle)
    }

    fun typeface(typeface: Font?): PrintTextFont = copy(text, typeface)
    fun fontSize(fontSize: Int): PrintTextFont = copy(text, typeface, fontSize)
    fun align(align: Align): PrintTextFont = copy(text, align = align)
    fun fontStyle(fontStyle: FontStyle): PrintTextFont = copy(text, fontStyle = fontStyle)
